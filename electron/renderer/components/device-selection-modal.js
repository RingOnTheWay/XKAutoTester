...
class DeviceSelectionModal {
    ...
    get confirmBtn() { return this.#confirmBtn; }
    set confirmBtn(v) { this.#confirmBtn = v; }
    get cancelBtn() { return this.#cancelBtn; }
    set cancelBtn(v) { this.#cancelBtn = v; }
    get closeBtn() { return this.#closeBtn; }
    set closeBtn(v) { this.#closeBtn = v; }
    get openPortBtn() { return this.#openPortBtn; }
    set openPortBtn(v) { this.#openPortBtn = v; }
    get boundConfirm() { return this.#boundConfirm; }
    set boundConfirm(v) { this.#boundConfirm = v; }
    get boundCancel() { return this.#boundCancel; }
    set boundCancel(v) { this.#boundCancel = v; }
    get boundClose() { return this.#boundClose; }
    set boundClose(v) { this.#boundClose = v; }
    get boundOpenPort() { return this.#boundOpenPort; }
    set boundOpenPort(v) { this.#boundOpenPort = v; }
    get mode() { return this.#mode; }
    set mode(v) { this.#mode = v; }
    get resolve() { return this.#resolve; }
    set resolve(v) { this.#resolve = v; }
    get reject() { return this.#reject; }
    set reject(v) { this.#reject = v; }
    get originalZIndex() { return this.#originalZIndex; }
    set originalZIndex(v) { this.#originalZIndex = v; }
    get modalSelectedDeviceId() { return this.#modalSelectedDeviceId; }
    set modalSelectedDeviceId(v) { this.#modalSelectedDeviceId = v; }
    get currentDeviceList() { return this.#currentDeviceList; }
    set currentDeviceList(v) { this.#currentDeviceList = v; }
    set androidVersion(v) { this.#androidVersion = v; }
    get deviceRefreshTimer() { return this.#deviceRefreshTimer; }
    set deviceRefreshTimer(v) { this.#deviceRefreshTimer = v; }
    get isDeviceRefreshing() { return this.#isDeviceRefreshing; }
    set isDeviceRefreshing(v) { this.#isDeviceRefreshing = v; }

...
// import 供内部使用 (三处收敛点), re-export 保持既有调用方兼容
import { toCaseFileName, inferTestTypeFromFileName } from '../../core/utils/testFile.js';

export { toCaseFileName, inferTestTypeFromFileName };

...
async function initializeServices() {
  ...
  const userDataService = new UserDataService(projectRoot, versionService);
  ...
  const pythonTestService = new PythonTestService({
    projectRoot,
    i18nService,
    userDataPath,
    mainWindow: null,
  ...
  const dataTransferService = new DataTransferService(userDataService, i18nService, versionService);

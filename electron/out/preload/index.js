...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  // 测试操作
  runPythonTests: (testConfig) => invokeWithCheck(IPC_CHANNELS.RUN_PYTHON_TESTS, testConfig),
  ...
  // 路径检查
  checkPathExists: (path2) => invokeWithCheck(IPC_CHANNELS.CHECK_PATH_EXISTS, path2),

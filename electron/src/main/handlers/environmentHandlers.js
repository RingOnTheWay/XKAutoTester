...
function register(ipcMain, services) {
  ...
  registerHandler(ipcMain, IPC_CHANNELS.INSTALL_DRIVER,            (installerPath) => environmentStartupService.handleInstallDriver(installerPath));
  registerHandler(ipcMain, IPC_CHANNELS.CHECK_INSTALLER_RUNNING,   () => environmentStartupService.handleCheckInstallerRunning());
  registerHandler(ipcMain, IPC_CHANNELS.RECHECK_CP210X_DRIVER,     () => environmentStartupService.handleRecheckCp210xDriver());

...
function register(ipcMain, services) {
  ...
  registerHandlers(ipcMain, {
    [IPC_CHANNELS.INSPECTOR_START_SESSION]: (deviceName, appPackage, appActivity, platformVersion, noReset) =>
      inspectorService.startSession(deviceName, appPackage, appActivity, platformVersion, noReset),

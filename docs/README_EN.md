...
[![Version](https://img.shields.io/badge/Version-0.1.6--dev.2-9cf?style=flat-square)](https://github.com/RingOnTheWay/XKAutoTester)
...
| :--------- | :-------------------------------: |
| Desktop App | Electron 43 + Native HTML/CSS/JS + Vite 5 / electron-vite |

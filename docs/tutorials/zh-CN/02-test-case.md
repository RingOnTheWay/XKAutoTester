...
![测试用例主界面](../images/02-test-case-main.png)
...
![选择测试目录](../images/02-select-directory.png)

---

## 步骤 2：新建测试用例

![新建用例按钮](../images/02-create-new.png)
...
![基本信息表单](../images/02-basic-info.png)
...
![应用平台选择](../images/02-app-platform.png)
...
![测试步骤配置](../images/02-step-config.png)
...
![步骤操作](../images/02-step-actions.png)
...
![Allure配置](../images/02-allure-config.png)
...
![蓝牙Mock配置](../images/02-ble-config.png)
